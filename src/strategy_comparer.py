...
class StrategyComparer:
    ...
    def compare_strategies(self, stock_ids, start_date, end_date):
        for stock_id in stock_ids:
            ...
            bah_result = self.backtester.buy_and_hold(price_df)
            ...
            bah_metrics = {
                ...
                'total_return': bah_result['returns'],  
                'sharpe_ratio': self.performance_analyzer.sharpe_ratio(bah_result['equity_curve'], 0)['sharpe_ratio'],
                'max_drawdown': self.performance_analyzer.max_drawdown(bah_result['equity_curve'])['max_drawdown'],
            ...
            pe_metrics = {
                ...
                'sharpe_ratio': self.performance_analyzer.sharpe_ratio(pe_result['equity_curve'], 0)['sharpe_ratio'],
                'max_drawdown': self.performance_analyzer.max_drawdown(pe_result['equity_curve'])['max_drawdown'],
            ...
            ma_metrics = {
                ...
                'sharpe_ratio': self.performance_analyzer.sharpe_ratio(ma_result['equity_curve'], 0)['sharpe_ratio'],
                'max_drawdown': self.performance_analyzer.max_drawdown(ma_result['equity_curve'])['max_drawdown'],
            ...
            rsi_metrics = {
                ...
                'sharpe_ratio': self.performance_analyzer.sharpe_ratio(rsi_result['equity_curve'], 0)['sharpe_ratio'],
                'max_drawdown': self.performance_analyzer.max_drawdown(rsi_result['equity_curve'])['max_drawdown'],
            ...
            kd_metrics = {
                ...
                'sharpe_ratio': self.performance_analyzer.sharpe_ratio(kd_result['equity_curve'], 0)['sharpe_ratio'],
                'max_drawdown': self.performance_analyzer.max_drawdown(kd_result['equity_curve'])['max_drawdown'],
